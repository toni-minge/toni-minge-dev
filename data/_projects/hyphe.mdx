...
Building the frontend was a bit of a feat. Not only did I have to render gameplay in real time, but the visualization had to reflect the artistic idea of the "hyphae".
